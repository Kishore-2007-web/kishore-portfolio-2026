...
const SpecularButton = ({
    ...
    try {
      ...
      const program = new Program(gl, {
        ...
        uniforms: {
          ...
          uBaseColor: { value: [0.35, 0.35, 0.35] },
          uIntensity: { value: 1 },
      ...
      console.warn('SpecularButton WebGL setup fallback active:', err);
    }
  ...
  if (href) {
    const defaultTarget = target || (href.startsWith('http') || href.startsWith('mailto:') || href.startsWith('https://wa.me') ? '_blank' : undefined);
    const defaultRel = rel || (href.startsWith('http') ? 'noopener noreferrer' : undefined);
